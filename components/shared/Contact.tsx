...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative w-full overflow-hidden bg-background" ref={ref}>
      <div className="px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-screen-2xl mx-auto  pt-16 pb-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold leading-tight dark:text-brandPrimaryLightShade">Contact Us</h1>
          <h2 className="text-2xl md:text-3xl font-bold mt-2 mb-6">Passionate About Visual Storytelling</h2>
          <p className="mb-6">
